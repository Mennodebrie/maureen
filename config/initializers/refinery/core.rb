...
Refinery::Core.configure do |config|
  ...
  # Site name
  config.site_name = "Maureen de Brie Mondhygiënist"
  ...
  config.menu_css = {:first=>"first", :selected=>"active", :last=>"last"}

  # Should set this if concerned about DOS attacks. See
  # http://markevans.github.com/dragonfly/file.Configuration.html#Configuration
  # config.dragonfly_secret = "f102c75d186817b28439c5863d28c4c8a980d82edcc83354"
